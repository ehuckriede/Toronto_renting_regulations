...
The results of the barplot of the neighborhoodsl ook like this:
```{r, echo=FALSE}
# --- Load Data --- #
...
```
The barplot shows that for every room type, except hotel room, prices increase after the regulation. That does make sense, because the regulation mainly effects the entire homes or apartments, or the private/shared rooms within someones house.
